...
'''
baseCase_file = r'V:\RTKC\Bingham Canyon\CX21495304_NPB_FS\FS2400_Method_Calibrations\Wall_Scale\RUN_4\02_Output_Files\12_Recompiled_Results\Run_4_failure_BaseCase_Only_all_sectors.csv'
...
for sector in tqdm(list(range(1,sector_num+1))):
    ...
    update_sector_file_path = os.path.join(output_directory,'02_Update_CSV', 'Run_4_BaseCase')
...
update_all_sector_csv_path = os.path.join(output_directory,'03_Final_CSV','Run_4_BaseCase')
update_all_sector_csv_name = 'Run_4_BaseCase_3DPOF_Results.csv'
